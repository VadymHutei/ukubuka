...
-- Dumping data for table ukubuka.page: ~1 rows (приблизно)
...
-- Dumping data for table ukubuka.page_text: ~2 rows (приблизно)
...
-- Dumping data for table ukubuka.product_text: ~0 rows (приблизно)

-- Dumping data for table ukubuka.session: ~10 rows (приблизно)
...
-- Dumping data for table ukubuka.session_user: ~3 rows (приблизно)
...
-- Dumping data for table ukubuka.text: ~85 rows (приблизно)
