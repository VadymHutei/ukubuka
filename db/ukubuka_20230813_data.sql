...
-- Dumping data for table ukubuka.cart: ~0 rows (приблизно)

-- Dumping data for table ukubuka.cart_session: ~0 rows (приблизно)

-- Dumping data for table ukubuka.cart_sku: ~0 rows (приблизно)

-- Dumping data for table ukubuka.cart_user: ~0 rows (приблизно)
...
-- Dumping data for table ukubuka.catalog_text: ~0 rows (приблизно)
...
-- Dumping data for table ukubuka.currency: ~0 rows (приблизно)
INSERT INTO `currency` (`id`, `code`, `symbol`, `is_active`, `created_at`, `updated_at`) VALUES
	(1, 'UAH', '₴', 1, '2023-08-13 19:24:31', '2023-08-13 19:24:32'),
	(2, 'USD', '$', 0, '2023-08-13 19:28:12', '2023-08-13 19:28:13');
...
-- Dumping data for table ukubuka.page: ~2 rows (приблизно)
INSERT INTO `page` (`id`, `code`, `template`, `is_active`, `created_at`, `updated_at`) VALUES
	(1, 'acp_languages', 'v1/acp/language/languages.html', 1, '2023-01-29 20:17:10', '2023-01-29 20:17:11'),
	(2, 'acp_dashboard', 'v1/acp/dashboard/dashboard.html', 1, '2023-02-18 12:49:49', '2023-02-18 12:49:51'),
	(3, 'acp_edit_language', 'v1/acp/language/edit_language.html', 1, '2023-06-04 21:59:51', '2023-06-04 21:59:53'),
	(4, 'product', 'v1/product.html', 1, '2023-08-13 16:39:09', '2023-08-13 16:39:10');

-- Dumping data for table ukubuka.page_text: ~6 rows (приблизно)
INSERT INTO `page_text` (`page_id`, `language_code`, `title`) VALUES
	(1, 'eng', 'Languages'),
	(1, 'ukr', 'Мови'),
	(2, 'eng', 'Dashboard'),
	(2, 'ukr', 'Панель приладів'),
	(3, 'eng', 'Language editing'),
	(3, 'ukr', 'Редагування мови');
...
INSERT INTO `product_price` (`id`, `product_id`, `currency_id`, `value`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 10000, '2023-08-13 19:33:55', NULL);
