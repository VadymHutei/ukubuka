...
-- Dumping data for table ukubuka.page: ~14 rows (приблизно)
INSERT INTO `page` (`id`, `code`, `template`, `layout`, `is_active`, `created_at`, `updated_at`) VALUES
	...
	(22, 'asd', 'qdqwd2', 'sfvfvsfv2', 1, '2024-01-20 22:22:01', '2024-02-04 21:56:37');

-- Dumping data for table ukubuka.page_text: ~24 rows (приблизно)
