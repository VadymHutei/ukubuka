...
CREATE TABLE IF NOT EXISTS `currency` (
  ...
  `separator` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `currency` (`id`, `code`, `symbol`, `symbol_position`, `separator`, `decimal_places`, `is_active`, `created_at`, `updated_at`) VALUES
	(1, 'UAH', '₴', 'after', ',', 2, 1, '2023-08-13 19:24:31', '2023-08-13 19:24:32'),
	(2, 'USD', '$', 'before', '.', 2, 1, '2023-08-13 19:28:12', '2023-08-13 19:28:13');
...
-- Dumping data for table ukubuka.product_price: ~2 rows (приблизно)
INSERT INTO `product_price` (`id`, `product_id`, `currency_id`, `value`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 20000, '2023-08-13 19:33:55', NULL),
	(2, 1, 2, 1000, '2024-10-06 23:52:45', NULL);
