...
-- Dumping data for table ukubuka.page: ~4 rows (приблизно)
INSERT INTO `page` (`id`, `code`, `template`, `is_active`, `created_at`, `updated_at`) VALUES
	(1, 'acp_languages', 'v1/acp/language/languages.html', 1, '2023-01-29 20:17:10', NULL),
	(2, 'acp_dashboard', 'v1/acp/dashboard/dashboard.html', 1, '2023-02-18 12:49:49', NULL),
	(3, 'acp_edit_language', 'v1/acp/language/edit_language.html', 1, '2023-06-04 21:59:51', NULL),
	(4, 'product', 'v1/product.html', 1, '2023-08-13 16:39:09', NULL);

-- Dumping data for table ukubuka.page_text: ~8 rows (приблизно)
INSERT INTO `page_text` (`id`, `page_id`, `language_id`, `title`, `created_at`, `updated_at`) VALUES
	...
	(5, 3, 1, 'Language editing', '2023-08-14 20:14:25', NULL),
	(6, 3, 2, 'Редагування мови', '2023-08-14 20:14:25', NULL),
