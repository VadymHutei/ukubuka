-- --------------------------------------------------------
-- Сервер:                       127.0.0.1
-- Версія сервера:               8.2.0 - MySQL Community Server - GPL
-- ОС сервера:                   Linux
...
-- Dumping data for table ukubuka.page: ~12 rows (приблизно)
INSERT INTO `page` (`id`, `code`, `template`, `layout`, `is_active`, `created_at`, `updated_at`) VALUES
	...
	(19, 'acp_page', 'v1/acp/page/page.html', 'v1/acp/layout/layout.html', 1, '2023-12-17 15:45:46', NULL),
	(20, 'acp_edit_page_translation', 'v1/acp/page/edit_page_translation.html', 'v1/acp/layout/layout.html', 1, '2023-12-17 16:03:30', '2023-12-17 23:54:04');

-- Dumping data for table ukubuka.page_text: ~23 rows (приблизно)
INSERT INTO `page_text` (`id`, `page_id`, `language_id`, `title`, `created_at`, `updated_at`) VALUES
	...
	(20, 10, 1, 'Edit page', '2023-12-10 21:00:57', NULL),
	(21, 10, 2, 'Редагувати сторінку', '2023-12-10 21:01:12', NULL),
	(22, 11, 1, 'Add page', '2023-12-10 21:02:56', NULL),
	(23, 11, 2, 'Додати сторінку', '2023-12-10 21:03:10', NULL),
	(24, 19, 1, 'Page', '2023-12-17 15:46:32', NULL),
	(25, 19, 2, 'Сторінка', '2023-12-17 15:46:45', NULL),
	(27, 20, 2, 'Редагувати переклад сторінки', '2023-12-17 22:17:07', '2023-12-17 23:37:55');
